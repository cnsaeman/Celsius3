...
public class ViewerText extends javax.swing.JFrame {
    ...
    private void findNext() {
        ...
        if ((pos==0) && (p==-1)) {
            toolbox.Warning(this,"Text not found.", "No result");
            return;
        }
        if (p==-1) {
            if (toolbox.QuestionYN(this,"Text not found in remainder of the document.\nStart search from the top?", "Please confirm:")==JOptionPane.YES_OPTION) {
                pos=0;
                findNext();
            }
            return;
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, RSC.guiScale(815), Short.MAX_VALUE))
        );
        jPanel2Layout.setVerticalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 447, Short.MAX_VALUE)
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, RSC.guiScale(447), Short.MAX_VALUE))
        );

        getContentPane().add(jPanel2, java.awt.BorderLayout.CENTER);

        jPanel1.setBorder(javax.swing.BorderFactory.createEmptyBorder(4, 4, 4, 4));
        jPanel1.setPreferredSize(new java.awt.Dimension(RSC.guiScale(400), RSC.guiScale(25)));

        javax.swing.GroupLayout jPanel1Layout = new javax.swing.GroupLayout(jPanel1);
        jPanel1.setLayout(jPanel1Layout);
        jPanel1Layout.setHorizontalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jStatus, javax.swing.GroupLayout.DEFAULT_SIZE, RSC.guiScale(813), Short.MAX_VALUE)
        );
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jStatus, javax.swing.GroupLayout.DEFAULT_SIZE, RSC.guiScale(17), Short.MAX_VALUE)
        );
    ...
    private void jMISaveCopyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMISaveCopyActionPerformed
        ...
        if (FC.showSaveDialog(this) != JFileChooser.CANCEL_OPTION) {
           (new InteractiveFileCopy(RSC.getMF(),filename, FC.getSelectedFile().getAbsolutePath(),RSC)).go();
        }
