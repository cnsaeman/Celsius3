...
class SplashScreen extends JFrame implements FocusListener{
   ...
   public SplashScreen(String version, boolean label, Resources RSC) {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(MainFrame.class.getResource("images/celsius.gif")));
