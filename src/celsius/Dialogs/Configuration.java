...
public class Configuration extends javax.swing.JDialog {
    ...
    public Configuration(MainFrame parent, Configurator cfg) {
        super(parent, true);
        RSC=parent.RSC;
        MF=parent;
        Configuration=cfg;
        initComponents();
        jTabbedPane1.setTabComponentAt(0, new TabLabel("General Configuration","wrench_orange",RSC,null,false));
        jTabbedPane1.setTabComponentAt(1, new TabLabel("Plugins","plugin",RSC,null,false));
        jTabbedPane1.setTabComponentAt(2, new TabLabel("File support","default",RSC,null,false));
        setIconImage(RSC.getOriginalIcon("wrench_orange"));
        jLFileTypes.setModel(Configuration.getTypeDLM());
        jLFileTypes.setSelectedIndex(0);
        Plugins=RSC.Plugins;
        LM1=Plugins.getPluginsDLM();
        jLP1.setModel(LM1);
        jTFIconFolder.setText(RSC.Configuration.getDefault("iconfolder"));
        jCBIcons.setModel(RSC.Icons.getDCBM());
        if (RSC.getCurrentSelectedLib()!=null)
            jCBIcons.setRenderer(new CBRenderer(RSC.Icons,RSC.getCurrentSelectedLib().IconDictionary,RSC));
        else
    ...
    private void addPlugin(DefaultListModel LM, String type) {
        ...
        if (!(FC.showOpenDialog(this) == JFileChooser.CANCEL_OPTION)) {
            try {
                Plugin p=new Plugin(Parser.CutTill(FC.getSelectedFile().getName(),".class"));
                if (Plugins.add(p)) {
                    LM1=Plugins.getPluginsDLM();
                    jLP1.setModel(LM1);
                    Plugins.updatePlugins();
                } else
                    toolbox.Warning(MF,"Pluging is already in the list.", "Warning");
            } catch (Exception e) {
                RSC.Msg1.printStackTrace(e);
                toolbox.Warning(MF,"Plugin couldn't be loaded:\n"+e.toString(), "Warning");
            }
        }
    }
    ...
    private void initComponents() {
        ...
        jBtnResetLog = new javax.swing.JButton();
        jBtnReloadIcons = new javax.swing.JButton();
        jLabel11 = new javax.swing.JLabel();
        jCBIcons = new javax.swing.JComboBox();
        jTFIconFolder = new javax.swing.JTextField();
        jBtnChoosIconFolder = new javax.swing.JButton();
        jLabel12 = new javax.swing.JLabel();
        jLabel13 = new javax.swing.JLabel();
        jCBLaF = new javax.swing.JComboBox();
        jBtnApplyLaF = new javax.swing.JButton();
        jBtnApply1 = new javax.swing.JButton();
        jPanel3 = new javax.swing.JPanel();
        jScrollPane2 = new javax.swing.JScrollPane();
        jLP1 = new javax.swing.JList();
        jLabel7 = new javax.swing.JLabel();
        jBSave = new javax.swing.JButton();
        jBtnReloadPlugins = new javax.swing.JButton();
        jLabel10 = new javax.swing.JLabel();
        JTFParams = new javax.swing.JTextField();
        jLabel8 = new javax.swing.JLabel();
        jScrollPane3 = new javax.swing.JScrollPane();
        jPluginText = new javax.swing.JEditorPane();
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(RSC.guiScale(0), RSC.guiScale(140)));

        jLabel1.setText("Starting email client and attach:");

        jBtnTest1.setText("Test");
        jBtnTest1.setPreferredSize(new java.awt.Dimension(RSC.guiScale(65), RSC.guiScale(20)));
        ...
        jCBproxy.setMargin(new java.awt.Insets(0, 0, 0, 0));
        ...
        jBtnTest4.setPreferredSize(new java.awt.Dimension(RSC.guiScale(65), RSC.guiScale(20)));
        ...
        jBtnResetLog.setText("Clear Logging File");
        jBtnResetLog.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBtnResetLogActionPerformed(evt);
            }
        });

        jBtnReloadIcons.setText("Reload Icons");
        jBtnReloadIcons.setPreferredSize(new java.awt.Dimension(RSC.guiScale(124), RSC.guiScale(20)));
        ...
        jBtnChoosIconFolder.setText("Choose");
        jBtnChoosIconFolder.setPreferredSize(new java.awt.Dimension(RSC.guiScale(124), RSC.guiScale(20)));
        jBtnChoosIconFolder.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBtnChoosIconFolderActionPerformed(evt);
            }
        });
        ...
        jCBLaF.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Standard" }));

        jBtnApplyLaF.setText("Apply");
        jBtnApplyLaF.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBtnApplyLaFActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(jTFEmail, javax.swing.GroupLayout.PREFERRED_SIZE, RSC.guiScale(532), javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jBtnTest4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jCBLaF, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jBtnApplyLaF))
                            .addComponent(jCBIcons, javax.swing.GroupLayout.PREFERRED_SIZE, RSC.guiScale(180), javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addComponent(jBtnApply1, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel11)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTFIconFolder)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jBtnChoosIconFolder, javax.swing.GroupLayout.PREFERRED_SIZE, RSC.guiScale(89), javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(4, 4, 4)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jBtnReloadIcons, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jBtnChoosIconFolder, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel12)
        ...
        jLP1.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
            public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
                jLP1ValueChanged(evt);
            }
        });
        jScrollPane2.setViewportView(jLP1);

        jLabel7.setText("Available Plugins:");
        ...
        jBtnReloadPlugins.setText("Reload Plugins");
        jBtnReloadPlugins.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBtnReloadPluginsActionPerformed(evt);
            }
        });

        jLabel10.setText("Parameters:");

        jLabel8.setText("Selected Plugin:");

        jScrollPane3.setViewportView(jPluginText);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, RSC.guiScale(224), javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(JTFParams)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jBSave))
                    .addComponent(jBtnReloadPlugins, javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel8, javax.swing.GroupLayout.PREFERRED_SIZE, RSC.guiScale(15), javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel7))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addComponent(jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, RSC.guiScale(229), Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jBSave)
                            .addComponent(JTFParams, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel10)))
                    .addComponent(jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, RSC.guiScale(260), Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jBtnReloadPlugins))
        );

        jTabbedPane1.addTab("Plugins", jPanel3);
        ...
        jBtnTest2.setPreferredSize(new java.awt.Dimension(RSC.guiScale(65), RSC.guiScale(20)));
        ...
        jBtnTest3.setPreferredSize(new java.awt.Dimension(RSC.guiScale(65), RSC.guiScale(20)));
        ...
        jBtnSystem.setPreferredSize(new java.awt.Dimension(RSC.guiScale(65), RSC.guiScale(20)));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, RSC.guiScale(119), javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTFIdent, javax.swing.GroupLayout.DEFAULT_SIZE, RSC.guiScale(563), Short.MAX_VALUE)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                .addComponent(jTFView, javax.swing.GroupLayout.DEFAULT_SIZE, RSC.guiScale(454), Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jBtnSystem, javax.swing.GroupLayout.PREFERRED_SIZE, RSC.guiScale(103), javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(jTFExtract, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, RSC.guiScale(563), Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addComponent(jTFSecondary, javax.swing.GroupLayout.DEFAULT_SIZE, RSC.guiScale(719), Short.MAX_VALUE))
                .addContainerGap())
        );
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(jBtnTest2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jTFExtract, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(jBtnTest3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    ...
                                    .addComponent(jBtnSystem, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jLabel3))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jBtnApply)
                            .addComponent(jBtnRestore)))
                    .addComponent(jScrollPane1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, RSC.guiScale(304), Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jButton4.setPreferredSize(new java.awt.Dimension(RSC.guiScale(34), RSC.guiScale(25)));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addComponent(jButton4, javax.swing.GroupLayout.PREFERRED_SIZE, RSC.guiScale(74), javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void jBtnTest4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnTest4ActionPerformed
        ...
        if (!(returnVal==JFileChooser.CANCEL_OPTION)) {
            ...
            try {
                ...
                ES.start();
            } catch (IOException e) { RSC.Msg1.printStackTrace(e); }
        }
    ...
    private void jCBproxyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCBproxyActionPerformed
        toolbox.Information(MF,"Note that Celsius has to be restarted for the\nproxy settings to be changed.","Warning");
    ...
    private void jBtnTest2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnTest2ActionPerformed
        ...
        if (!(returnVal==JFileChooser.CANCEL_OPTION)) {
            try {
                ...
                toolbox.Information(MF,output,"Results of extraction, first 60 characters");
                TextFile.Delete(location+".ttxxtt");
            } catch (Exception e) {
                RSC.Msg1.printStackTrace(e);
                toolbox.Warning(MF,"Error Msg:"+e.toString(),"Error encountered!");
            }
        }
    ...
    private void jBtnApplyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnApplyActionPerformed
        ...
        Configuration.writeFileType(ft, jTFExtract.getText(),jTFView.getText(),jTFIdent.getText(),jTFSecondary.getText());
    ...
    private void jBtnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAddActionPerformed
        ...
        if (!DSLE.cancel) {
            Configuration.addType(DSLE.text);
    ...
    private void jBtnRestoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnRestoreActionPerformed
        if (jLFileTypes.getSelectedIndex()==-1) return;
        String ft=(String)jLFileTypes.getSelectedValue();
        jTFEmail.setText(Configuration.getDefault("email"));
        jTFAnnotate.setText(Configuration.getDefault("annotate"));
        jTFView.setText(Configuration.getType(ft,"Viewer"));
        jTFExtract.setText(Configuration.getType(ft,"Extractor"));
        jTFIdent.setText(Configuration.getType(ft,"Ident"));
    ...
    private void jLFileTypesValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jLFileTypesValueChanged
        ...
        jTFEmail.setText(Configuration.getDefault("email"));
        jTFAnnotate.setText(Configuration.getDefault("annotate"));
        jTFproxyaddress.setText(Configuration.getDefault("proxy-address"));
        jTFproxyaddress.setEnabled(Configuration.getDefault("proxy").equals("true"));
        jTFproxyport.setText(Configuration.getDefault("proxy-port"));
        jTFproxyport.setEnabled(Configuration.getDefault("proxy").equals("true"));
        jCBproxy.setSelected(Configuration.getDefault("proxy").equals("true"));
        
        jTFView.setText(Configuration.getType(ft,"Viewer"));
        jTFExtract.setText(Configuration.getType(ft,"Extractor"));
        jTFIdent.setText(Configuration.getType(ft,"Ident"));
        jTFSecondary.setText(Configuration.getType(ft,"Secondary"));
    ...
    private void jLP1ValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jLP1ValueChanged
        int pos=jLP1.getSelectedIndex();
        if (pos==-1) return;
        name=(String)jLP1.getSelectedValue();
        jPluginText.setContentType("text/html");
        jPluginText.setText(Plugins.getText(name));
        jPluginText.setCaretPosition(0);
        if (Plugins.get(name).metaData.get("parameter-help").equals("none.")) {
            JTFParams.setText("");
            JTFParams.setEnabled(false);
        } else {
            JTFParams.setEnabled(true);
            JTFParams.setText(Plugins.parameters.get(name));
        }
}//GEN-LAST:event_jLP1ValueChanged

    private void jBSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBSaveActionPerformed
        String lname=(String)jLP1.getSelectedValue();
        Plugins.parameters.put(lname,JTFParams.getText());
        try {
            Plugins.save();
        } catch (Exception e) {
            RSC.Msg1.printStackTrace(e);
            toolbox.Warning(MF,"Error saving plugin configuration file.", "Error:");
        }
}//GEN-LAST:event_jBSaveActionPerformed

    private void jBtnReloadPluginsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnReloadPluginsActionPerformed
        Plugins.ReadIn();
        Plugins.updatePlugins();
        LM1=Plugins.getPluginsDLM();
        jLP1.setModel(LM1);
}//GEN-LAST:event_jBtnReloadPluginsActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        setVisible(false);
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jBtnResetLogActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnResetLogActionPerformed
        RSC.resetLogFile();
    }//GEN-LAST:event_jBtnResetLogActionPerformed
    ...
    private void jBtnReloadIconsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnReloadIconsActionPerformed
        RSC.Icons=new Icons(Configuration.getDefault("iconfolder"));
        jCBIcons.setModel(RSC.Icons.getDCBM());
        jCBIcons.setRenderer(new CBRenderer(RSC.Icons,RSC.getCurrentSelectedLib().IconDictionary,RSC));
    }//GEN-LAST:event_jBtnReloadIconsActionPerformed

    private void jBtnChoosIconFolderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnChoosIconFolderActionPerformed
        JFileChooser FC = new JFileChooser();
        ...
        if (!(FC.showOpenDialog(this) == JFileChooser.CANCEL_OPTION)) {
            ...
            Configuration.writeDefault("iconfolder",FC.getSelectedFile().getAbsolutePath());
            Configuration.writeBack();            
        }        
    }//GEN-LAST:event_jBtnChoosIconFolderActionPerformed

    private void jBtnApplyLaFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnApplyLaFActionPerformed
        String tmp=(String)jCBLaF.getSelectedItem();
        try {
            for (LookAndFeelInfo info : UIManager.getInstalledLookAndFeels()) {
                if (tmp.equals(info.getName())) {
                    UIManager.setLookAndFeel(info.getClassName());
                    RSC.LookAndFeel=info.getName();
                    toolbox.Warning(MF,"Celsius must be restarted for the change to take effect.", "Please note:");
                    break;
                }
            }
        } catch (Exception e) {
    ...
    }//GEN-LAST:event_jBtnApplyLaFActionPerformed

    private void jBtnApply1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnApply1ActionPerformed
        Configuration.writeDefault(jTFEmail.getText(),jTFAnnotate.getText(),jTFproxyaddress.getText(),jTFproxyport.getText(),jCBproxy.isSelected());
        jTFEmail.setText(Configuration.getDefault("email"));
        jTFAnnotate.setText(Configuration.getDefault("annotate"));
    ...
    private javax.swing.JTextField JTFParams;
    private javax.swing.JButton jBSave;
    private javax.swing.JButton jBtnAdd;
    private javax.swing.JButton jBtnApply;
    private javax.swing.JButton jBtnApply1;
    private javax.swing.JButton jBtnApplyLaF;
    private javax.swing.JButton jBtnChoosIconFolder;
    ...
    private javax.swing.JButton jBtnReloadPlugins;
    private javax.swing.JButton jBtnRemove;
    private javax.swing.JButton jBtnResetLog;
    ...
    private javax.swing.JEditorPane jPluginText;
