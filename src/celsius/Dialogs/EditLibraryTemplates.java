...
public class EditLibraryTemplates extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTLibTemplates.setFont(new java.awt.Font("Arial", 0, RSC.guiScale(11)));
        jTLibTemplates.getTableHeader().setFont(new java.awt.Font("Arial", 0, RSC.guiScale(11)));
        jTLibTemplates.setRowHeight(RSC.guiScale(16));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jBtnAdd, javax.swing.GroupLayout.PREFERRED_SIZE, RSC.guiScale(65), javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jBtnDelete))
                    .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, RSC.guiScale(148), javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, RSC.guiScale(482), Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, RSC.guiScale(212), Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(jBtnEditStyleFile)
                                .addComponent(jBtnApply))))
                    .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, RSC.guiScale(243), Short.MAX_VALUE))
                .addGap(6, 6, 6)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jBtnDone)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
            ...
            if ((value!=null) && !value.equals(xml.get(RSC.LibraryFields[i]))) {
                ...
                if (RSC.LibraryFields[i].equals("name")) {
                    if (DLM.contains(value)) {
                        ...
                        toolbox.Warning(this,"A library template with this name already exists.", "Cancelled...");
                        updateTable();
                    } else {
    ...
    private void jBtnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAddActionPerformed
        if (RSC.LibraryTemplates.get("New template")!=null) {
            toolbox.Warning(MF, "Please rename template called 'New template' first.", "Not possible:");
            return;
        }
        int i=toolbox.QuestionOC(this,"This will create a new library template from the currently active library.", "Add a new library template");
        if (i==0) {
            ...
            if (Lib!=null) {
                for (i=1;i<RSC.LibraryFields.length;i++) {
                    xml.put(RSC.LibraryFields[i], Lib.MainFile.get(RSC.LibraryFields[i]));
                }
                String tmp=TextFile.ReadOutFile(Lib.completeDir(Lib.MainFile.get("style"), ""));
                for (int j=0;j<8;j++) {
                ...
                toolbox.Warning(this,"There is currently no library open.", "Cancelled...");
            }
        }
    }//GEN-LAST:event_jBtnAddActionPerformed

    private void jBtnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnDeleteActionPerformed
        int i=toolbox.QuestionYN(this,"Do you really want to delete this library template?", "Please confirm:");
        if (i==0) {
            goToSelected();
