...
public class CreateNewLibrary extends javax.swing.JDialog {
    ...
    public CreateNewLibrary(MainFrame parent,Resources rsc) {
        ...
        changed=false;
        RSC=rsc;
        setIconImage(RSC.getOriginalIcon("new"));
        MF=parent;
        initComponents();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jTFLibDir, javax.swing.GroupLayout.DEFAULT_SIZE, RSC.guiScale(333), Short.MAX_VALUE)
                            .addComponent(jTFMainFile, javax.swing.GroupLayout.DEFAULT_SIZE, RSC.guiScale(333), Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTFName, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, RSC.guiScale(382), Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void jBAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAcceptActionPerformed
        try {
            ...
            for (Library lib : RSC.Libraries) {
                if (name.equals(lib.MainFile.get("name"))) {
                    toolbox.Warning(this,"A library with this name is already loaded. Cancelling...","Warning:");
                    return;
                }
            }
            if (jTFLibDir.getText().endsWith("/")) jTFLibDir.setText(Parser.CutTillLast(jTFLibDir.getText(),"/"));
            
            boolean proceed=true;
            if ((new File(jTFMainFile.getText())).exists()) {
                proceed=(toolbox.QuestionOC(this,"A file with the selected name already exists.\nOverwrite the existing file?","Warning:")==JOptionPane.YES_OPTION);
            }
            if (proceed && ((new File(jTFLibDir.getText())).exists())) {
                proceed=(toolbox.QuestionOC(this,"A directory with the selected name already exists.\nContinue anyway?","Warning:")==JOptionPane.YES_OPTION);
            }
            if (!proceed) return;
            ...
            if (!ok) {
                toolbox.Warning(this,"The directory for the library could not be created.","Warning");
                return;
            }
            TextFile.Delete(jTFMainFile.getText());            
            ...
            toolbox.Warning(this,"Exception: "+ex.toString(), "Warning");
        }
